...
var Rn = (()=>{
    ...
    return function(n = {}) {
        ...
        function ht(e) {
            if (e == te && ae) return new Uint8Array(ae);
            throw "both async and sync fetching of the wasm failed";
        }
        function Yt(e) {
            return ae || typeof fetch != "function" ? Promise.resolve().then(()=>ht(e)) : fetch(e, {
        ...
        function Nt(e, t) {
            var r = te;
            return ae || typeof WebAssembly.instantiateStreaming != "function" || ut(r) || typeof fetch != "function" ? ct(r, e, t) : fetch(r, {
                credentials: "same-origin"
        ...
        var ne = {}, K = {}, we = {}, le, Y = (e, t, r)=>{
            function i(u) {
                if (u = r(u), u.length !== e.length) throw new le("Mismatched type converter count");
                for(var p = 0; p < e.length; ++p)D(e[p], u[p]);
            }
            ...
            for(var t = ""; E[e];)t += gt[E[e++]];
            return t;
        }, _;
        function qt(e, t, r = {}) {
            var i = t.name;
            if (!e) throw new _(`type "${i}" must have a positive integer typeid pointer`);
        ...
        }, $e = false, _t = ()=>{}, yt = (e, t, r)=>t === r ? e : r.Ca === void 0 ? null : (e = yt(e, t, r.Ca), e === null ? null : r.ab(e)), wt = {}, ue = [], De = ()=>{
            for(; ue.length;){
                var e = ue.pop();
                e.ma.Ka = false, e.delete();
            }
        }, de, he = {}, Kt = (e, t)=>{
            if (t === void 0) throw new _("ptr should not be undefined");
            for(; e.Ca;)t = e.Na(t), e = e.Ca;
            return he[t];
        }, Ce = (e, t)=>{
            if (!t.za || !t.ya) throw new le("makeClassHandle requires ptr and ptrType");
            if (!!t.Da != !!t.Aa) throw new le("Both smartPtrType and smartPtr must be specified");
            return t.count = {
                value: 1
            }, ce(Object.create(e, {
                ma: {
        ...
        var pe = (e, t)=>Object.defineProperty(t, "name", {
            ...
            if (e[t].Ba === void 0) {
                var i = e[t];
                e[t] = function(...o) {
                    if (!e[t].Ba.hasOwnProperty(o.length)) throw new _(`Function '${r}' called with an invalid number of arguments (${o.length}) - expects one of (${e[t].Ba})!`);
                    return e[t].Ba[o.length].apply(this, o);
                }, e[t].Ba = [], e[t].Ba[i.Oa] = i;
            }
        }, Re = (e, t, r)=>{
            if (a.hasOwnProperty(e)) {
                if (r === void 0 || a[e].Ba !== void 0 && a[e].Ba[r] !== void 0) throw new _(`Cannot register public name '${e}' twice`);
                if (Ct(a, e, e), a.hasOwnProperty(r)) throw new _(`Cannot register multiple overloads of a function with the same number of arguments (${r})!`);
                a[e].Ba[r] = t;
        ...
        var We = (e, t, r)=>{
            for(; t !== r;){
                if (!t.Na) throw new _(`Expected null or instance of ${r.name}, got an instance of ${t.name}`);
                e = t.Na(e), t = t.Ca;
            }
            return e;
        };
        function Zt(e, t) {
            if (t === null) {
                if (this.Ta) throw new _(`null is not a valid ${this.name}`);
                return 0;
            }
            if (!t.ma) throw new _(`Cannot pass "${Ve(t)}" as a ${this.name}`);
            if (!t.ma.ya) throw new _(`Cannot pass deleted object as a pointer of type ${this.name}`);
        ...
        function en(e, t) {
            ...
            if (!t || !t.ma) throw new _(`Cannot pass "${Ve(t)}" as a ${this.name}`);
            if (!t.ma.ya) throw new _(`Cannot pass deleted object as a pointer of type ${this.name}`);
            if (!this.Pa && t.ma.za.Pa) throw new _(`Cannot convert argument of type ${t.ma.Da ? t.ma.Da.name : t.ma.za.name} to parameter type ${this.name}`);
            if (r = We(t.ma.ya, t.ma.za.xa, this.xa), this.Qa) {
                if (t.ma.Aa === void 0) throw new _("Passing raw pointer to smart pointer is illegal");
                switch(this.pb){
                    case 0:
                        if (t.ma.Da === this) r = t.ma.Aa;
                        else throw new _(`Cannot convert argument of type ${t.ma.Da ? t.ma.Da.name : t.ma.za.name} to parameter type ${this.name}`);
                        break;
                    case 1:
                        r = t.ma.Aa;
                        break;
        ...
        function tn(e, t) {
            ...
            if (!t.ma) throw new _(`Cannot pass "${Ve(t)}" as a ${this.name}`);
            if (!t.ma.ya) throw new _(`Cannot pass deleted object as a pointer of type ${this.name}`);
            if (t.ma.za.Pa) throw new _(`Cannot convert argument of type ${t.ma.za.name} to parameter type ${this.name}`);
            return We(t.ma.ya, t.ma.za.xa, this.xa);
        }
        ...
        var bt = (e, t, r)=>{
            if (!a.hasOwnProperty(e)) throw new le("Replacing nonexistent public symbol");
            ...
            if (typeof r != "function") throw new _(`unknown function pointer with signature ${e}: ${t}`);
            return r;
        }, Lt, Mt = (e)=>{
            e = kt(e);
            var t = P(e);
            ...
            for(var r = [], i = 0; i < e; i++)r.push(M[t + 4 * i >> 2]);
            return r;
        };
        function an(e) {
        ...
        function je(e, t, r, i, o) {
            var s = t.length;
            if (2 > s) throw new _("argTypes array size mismatch! Must at least get return value and 'this' types!");
            var d = t[1] !== null && r !== null, u = an(t), p = t[0].name !== "void", c = s - 2, m = Array(c), y = [], b = [];
            return pe(e, function(...l) {
                if (l.length !== c) throw new _(`function ${e} called with ${l.length} arguments, expected ${c}`);
                if (b.length = 0, y.length = d ? 2 : 1, y[0] = o, d) {
                    var f = t[1].toWireType(b, this);
                    y[1] = f;
                }
                for(var v = 0; v < c; ++v)m[v] = t[v + 2].toWireType(b, l[v]), y.push(m[v]);
                if (l = i(...y), u) Te(b);
                else for(v = d ? 1 : 2; v < t.length; v++){
                    var I = v === 1 ? f : m[v - 2];
        ...
        var Et = (e)=>{
            ...
            if (!e) throw new _("Cannot use deleted val. handle = " + e);
            return B[e];
        }, Me = (e)=>{
            switch(e){
                case void 0:
            ...
            var r = K[e];
            if (r === void 0) throw e = `${t} has unknown type ${Mt(e)}`, new _(e);
            return r;
        }, Ve = (e)=>{
            ...
            for(var r = e >> 1, i = r + t / 2; !(r >= i) && ie[r];)++r;
            if (r <<= 1, 32 < r - e && It) return It.decode(E.subarray(e, r));
            for(r = "", i = 0; !(i >= t / 2); ++i){
                var o = ee[e + 2 * i >> 1];
                if (o == 0) break;
            ...
            for(var r = Array(e), i = 0; i < e; ++i)r[i] = He(M[t + 4 * i >> 2], "parameter " + i);
            return r;
            ...
            if (!Ge) {
                ...
                for(t in Ne)Ne[t] === void 0 ? delete e[t] : e[t] = Ne[t];
                var r = [];
            ...
            _e("initRandomDevice");
        }, St = (e)=>(St = yn())(e), Ee = (e)=>e % 4 === 0 && (e % 100 !== 0 || e % 400 === 0), At = [
            31,
            29,
            31,
            30,
        ...
        var Cn = (e, t, r, i)=>{
            function o(l, f, v) {
                for(l = typeof l == "number" ? l.toString() : l || ""; l.length < f;)l = v[0] + l;
                return l;
            }
            function s(l, f) {
                return o(l, f, "0");
            ...
            function p(l) {
                ...
                for(l = new Date(new Date(l.Ja + 1900, 0, 1).getTime()); 0 < f;){
                    ...
                    if (f > I - l.getDate()) f -= I - l.getDate() + 1, l.setDate(1), 11 > v ? l.setMonth(v + 1) : (l.setMonth(0), l.setFullYear(l.getFullYear() + 1));
                    else {
            ...
            for(var m in c)r = r.replace(new RegExp(m, "g"), c[m]);
            ...
            c = {
                "%a": (l)=>y[l.Ga].substring(0, 3),
                "%A": (l)=>y[l.Ga],
                "%b": (l)=>b[l.Sa].substring(0, 3),
                "%B": (l)=>b[l.Sa],
                "%C": (l)=>s((l.Ja + 1900) / 100 | 0, 2),
                "%d": (l)=>s(l.Va, 2),
                "%e": (l)=>o(l.Va, 2, " "),
                "%g": (l)=>p(l).toString().substring(2),
                "%G": p,
                "%H": (l)=>s(l.Ra, 2),
                "%I": (l)=>(l = l.Ra, l == 0 ? l = 12 : 12 < l && (l -= 12), s(l, 2)),
                "%j": (l)=>{
                ...
                "%n": ()=>`
`,
                "%p": (l)=>0 <= l.Ra && 12 > l.Ra ? "AM" : "PM",
                "%S": (l)=>s(l.sb, 2),
                "%t": ()=>"	",
                "%u": (l)=>l.Ga || 7,
                "%U": (l)=>s(Math.floor((l.Ia + 7 - l.Ga) / 7), 2),
                "%V": (l)=>{
                    var f = Math.floor((l.Ia + 7 - (l.Ga + 6) % 7) / 7);
                    if (2 >= (l.Ga + 371 - l.Ia - 2) % 7 && f++, f) f == 53 && (v = (l.Ga + 371 - l.Ia) % 7, v == 4 || v == 3 && Ee(l.Ja) || (f = 1));
                    else {
                        f = 52;
                ...
                "%w": (l)=>l.Ga,
                "%W": (l)=>s(Math.floor((l.Ia + 7 - (l.Ga + 6) % 7) / 7), 2),
                "%y": (l)=>(l.Ja + 1900).toString().substring(2),
                "%Y": (l)=>l.Ja + 1900,
                "%z": (l)=>{
                    l = l.qb;
                    var f = 0 <= l;
            ...
            for(m in c)r.includes(m) && (r = r.replace(new RegExp(m, "g"), c[m](i)));
        ...
        for(var Tt = Array(256), Fe = 0; 256 > Fe; ++Fe)Tt[Fe] = String.fromCharCode(Fe);
        gt = Tt, _ = a.BindingError = class extends Error {
            ...
            isAliasOf: function(e) {
                if (!(this instanceof be && e instanceof be)) return false;
                var t = this.ma.za.xa, r = this.ma.ya;
                e.ma = e.ma;
                var i = e.ma.za.xa;
                for(e = e.ma.ya; t.Ca;)r = t.Na(r), t = t.Ca;
                for(; i.Ca;)e = i.Na(e), i = i.Ca;
                return t === i && r === e;
            },
            clone: function() {
                if (this.ma.ya || ke(this), this.ma.Ma) return this.ma.count.value += 1, this;
                ...
                })), e.ma.count.value += 1, e.ma.Ka = false, e;
            },
            delete () {
                if (this.ma.ya || ke(this), this.ma.Ka && !this.ma.Ma) throw new _("Object already scheduled for deletion");
                _t(this);
                var e = this.ma;
            ...
            var e = [], t;
            for(t in he)he.hasOwnProperty(t) && e.push(he[t]);
            return e;
            ...
            fromWireType: function(e) {
                ...
                var i = Kt(this.xa, r);
                if (i !== void 0) return i.ma.count.value === 0 ? (i.ma.ya = r, i.ma.Aa = e, i.clone()) : (i = i.clone(), this.Xa(e), i);
                if (i = this.xa.cb(r), i = wt[i], !i) return t.call(this);
                i = this.Pa ? i.$a : i.pointerType;
                var o = yt(r, this.xa, i.xa);
                return o === null ? t.call(this) : this.Qa ? Ce(i.xa.La, {
                    za: i,
                    ya: o,
                    Da: this,
                    Aa: e
...
` + i.replace(/^Error(:[^\n]*)?\n/, ""));
        ...
        var bn = {
            c: (e, t, r, i)=>{
                _e(`Assertion failed: ${e ? q(E, e) : ""}, at: ` + [
                    t ? t ? q(E, t) : "" : "unknown filename",
                    r,
                    i ? i ? q(E, i) : "" : "unknown function"
                ]);
            },
            m: (e, t, r)=>{
                var i = new Gt(e);
            ...
            r: (e, t, r, i, o, s, d, u, p, c, m, y, b)=>{
                ...
                var l = Xt(m);
                Re(l, function() {
                    Le(`Cannot construct ${m} due to unbound types`, [
                        i
                    ]);
                }), Y([
                    e,
                    ...
                    if (f = f[0], i) var v = f.xa, I = v.La;
                    else I = be.prototype;
                    f = pe(m, function(...qe) {
                        if (Object.getPrototypeOf(this) !== N) throw new _("Use 'new' to construct " + m);
                        if (T.Ha === void 0) throw new _(m + " has no accessible constructor");
                        var Rt = T.Ha[qe.length];
                        if (Rt === void 0) throw new _(`Tried to invoke ctor of ${m} with invalid number of parameters (${qe.length}) - expected (${Object.keys(T.Ha).toString()}) parameters instead!`);
                    ...
                    return v = new me(m, T, true, false, false), fe = new me(m + "*", T, false, false, false), I = new me(m + " const*", T, false, true, false), wt[e] = {
                        pointerType: fe,
                        $a: I
                    }, bt(l, f), [
                        v,
            ...
            q: (e, t, r, i, o, s)=>{
                ...
                o = A(i, o), Y([], [
                    ...
                    if (u.xa.Ha === void 0 && (u.xa.Ha = []), u.xa.Ha[t - 1] !== void 0) throw new _(`Cannot register multiple constructors with identical number of parameters (${t - 1}) for class '${u.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
                    return u.xa.Ha[t - 1] = ()=>{
            ...
            x: (e, t, r, i)=>{
                ...
                t = P(t), o.values = {}, D(e, {
                    ...
                    toWireType: (s, d)=>d.value,
                    argPackAdvance: 8,
                    readValueFromPointer: on(t, r, i),
                    Ea: null
                }), Re(t, o);
            },
            k: (e, t, r)=>{
                var i = He(e, "enum");
                t = P(t), e = i.constructor, i = Object.create(i.constructor.prototype, {
                    value: {
                        value: r
                    },
                    constructor: {
                        value: pe(`${i.name}_${t}`, function() {})
                    }
                }), e.values[r] = i, e[t] = i;
            },
            C: (e, t, r)=>{
            ...
            l: (e, t, r, i, o)=>{
                ...
                D(e, {
                    ...
                    toWireType: d,
                    argPackAdvance: 8,
                    readValueFromPointer: ln(t, r, i !== 0),
                    Ea: null
                });
            },
            g: (e, t, r)=>{
            ...
            ca: (e, t, r, i, o, s, d, u, p, c, m, y)=>{
                r = P(r), s = A(o, s), u = A(d, u), c = A(p, c), y = A(m, y), Y([
                    e
                ], [
                    t
                ], (b)=>(b = b[0], [
                        new me(r, b.xa, false, false, true, b, i, s, u, c, y)
                    ]));
            },
            D: (e, t)=>{
                t = P(t);
                ...
                D(e, {
                    ...
                    fromWireType: function(i) {
                        var o = M[i >> 2], s = i + 4;
                        if (r) for(var d = s, u = 0; u <= o; ++u){
                            var p = s + u;
                            if (u == o || E[p] == 0) {
                                if (d = d ? q(E, d, p - d) : "", c === void 0) var c = d;
                                else c += "\0", c += d;
                                d = p + 1;
                            }
                        }
                        else {
                            for(c = Array(o), u = 0; u < o; ++u)c[u] = String.fromCharCode(E[s + u]);
                            c = c.join("");
                        }
                        return H(i), c;
                    },
                    toWireType: function(i, o) {
                        ...
                        if (!(s || o instanceof Uint8Array || o instanceof Uint8ClampedArray || o instanceof Int8Array)) throw new _("Cannot pass non-string to std::string");
                        var d = r && s ? ft(o) : o.length, u = Je(4 + d + 1), p = u + 4;
                        if (M[u >> 2] = d, r && s) vt(o, E, p, d + 1);
                        else if (s) for(s = 0; s < d; ++s){
                            var c = o.charCodeAt(s);
                            if (255 < c) throw H(p), new _("String has UTF-16 code units that do not fit in 8 bits");
                            E[p + s] = c;
                        }
                        else for(s = 0; s < d; ++s)E[p + s] = o[s];
            ...
            u: (e, t, r)=>{
                if (r = P(r), t === 2) var i = un, o = dn, s = hn, d = (u)=>ie[u >> 1];
                else t === 4 && (i = cn, o = pn, s = mn, d = (u)=>M[u >> 2]);
                D(e, {
                    name: r,
                    fromWireType: (u)=>{
                    ...
                    toWireType: (u, p)=>{
                        if (typeof p != "string") throw new _(`Cannot pass non-string to C++ string type ${r}`);
            ...
            aa: (e, t, r, i)=>(e = Ye[e], t = Be(t), e(null, t, r, i)),
            F: Ue,
            $: (e, t, r)=>{
                ...
                return t = `methodCaller<(${i.map((d)=>d.name).join(", ")}) => ${o.name}>`, fn(pe(t, (d, u, p, c)=>{
                    for(var m = 0, y = 0; y < e; ++y)s[y] = i[y].readValueFromPointer(c + m), m += i[y].argPackAdvance;
            ...
            S: (e, t)=>{
                ...
                return Pt().forEach((i, o)=>{
                    var s = t + r;
                    for(o = M[e + 4 * o >> 2] = s, s = 0; s < i.length; ++s)G[o++] = i.charCodeAt(s);
                    G[o] = 0, r += i.length + 1;
                }), 0;
            },
            T: (e, t)=>{
            ...
            if (J++, a.monitorRunDependencies?.(J), a.instantiateWasm) try {
        ...
        function Dt() {
            function e() {
                if (!Ie && (Ie = true, a.calledRun = true, !nt)) {
                    if (xe(st), h(a), a.onRuntimeInitialized && a.onRuntimeInitialized(), a.postRun) for(typeof a.postRun == "function" && (a.postRun = [
                        a.postRun
                    ]); a.postRun.length;){
...
var L = class L2 {
    constructor(n){
        ...
        this._canvas = n.canvas, this._context = this._canvas.getContext("2d"), this._eventManager = new re(), this._frameManager = new Pe(), this._renderConfig = n.renderConfig ?? {}, X.load().then((a)=>{
            L2._wasmModule = a, this._dotLottieCore = new a.DotLottiePlayer({
                autoplay: n.autoplay ?? false,
                backgroundColor: 0,
                loopAnimation: n.loop ?? false,
                mode: Qe(n.mode ?? "forward", a),
                segment: tt(n.segment ?? [], a),
                speed: n.speed ?? 1,
                useFrameInterpolation: n.useFrameInterpolation ?? true,
                marker: n.marker ?? "",
                layout: n.layout ? {
                    align: et(n.layout.align, a),
                    fit: Ze(n.layout.fit, a)
                } : a.createDefaultLayout()
            ...
            this._eventManager.dispatch({
                type: "loadError",
                error: new Error(`Failed to load wasm module: ${a}`)
            });
        });
    }
    _loadFromSrc(n) {
        async function a() {
            let h = await fetch(n);
            if (!h.ok) throw new Error(`Failed to fetch the animation data from URL: ${n}. ${h.status}: ${h.statusText}`);
            let w = (h.headers.get("content-type") ?? "").trim(), x;
            return [
                "application/json",
                "text/plain"
            ].some((j)=>w.startsWith(j)) ? x = await h.text() : x = await h.arrayBuffer(), x;
        }
        a().then((h)=>{
            ...
            this._eventManager.dispatch({
                type: "loadError",
                error: new Error(`Failed to load animation data from URL: ${n}. ${h}`)
            });
        });
    }
    _loadFromData(n) {
        ...
        if (typeof n == "string") w = this._dotLottieCore.loadAnimationData(n, a, h);
        else if (n instanceof ArrayBuffer) w = this._dotLottieCore.loadDotLottieData(n, a, h);
        else if (typeof n == "object") w = this._dotLottieCore.loadAnimationData(JSON.stringify(n), a, h);
        else {
            this._eventManager.dispatch({
                type: "loadError",
        ...
        w ? (this._eventManager.dispatch({
            type: "load"
        }), V && this.resize(), this._eventManager.dispatch({
            type: "frame",
    ...
    load(n) {
        this._dotLottieCore === null || L2._wasmModule === null || (this._dotLottieCore.setConfig({
            autoplay: n.autoplay ?? false,
            backgroundColor: 0,
            loopAnimation: n.loop ?? false,
            mode: Qe(n.mode ?? "forward", L2._wasmModule),
            segment: tt(n.segment ?? [], L2._wasmModule),
            speed: n.speed ?? 1,
            useFrameInterpolation: n.useFrameInterpolation ?? true,
            marker: n.marker ?? "",
            layout: n.layout ? {
                align: et(n.layout.align, L2._wasmModule),
                fit: Ze(n.layout.fit, L2._wasmModule)
            } : L2._wasmModule.createDefaultLayout()
    ...
    _render() {
        ...
        if (this._dotLottieCore.render()) {
            ...
            return typeof ImageData > "u" ? (w = this._context.createImageData(this._canvas.width, this._canvas.height), w.data.set(h)) : w = new ImageData(h, this._canvas.width, this._canvas.height), this._context.putImageData(w, 0, 0), this._eventManager.dispatch({
                type: "render",
                currentFrame: this._dotLottieCore.currentFrame()
            }), true;
        }
    ...
    play() {
        ...
        this._isFrozen = false, n && (this._eventManager.dispatch({
            type: "play"
        }), this._animationFrameId = this._frameManager.requestAnimationFrame(this._draw.bind(this)));
    }
    pause() {
    ...
    setBackgroundColor(n) {
        this._dotLottieCore !== null && (V && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = n : this._dotLottieCore.setConfig({
            ...this._dotLottieCore.config(),
            backgroundColor: Ot(n)
    ...
    setLayout(n) {
        this._dotLottieCore === null || L2._wasmModule === null || this._dotLottieCore.setConfig({
            ...this._dotLottieCore.config(),
            layout: {
                align: et(n.align, L2._wasmModule),
                fit: Ze(n.fit, L2._wasmModule)
            }
        });
    }
    setViewport(n, a, h, w) {
    ...
    getStateMachineListeners() {
        ...
        for(let h = 0; h < n.size(); h += 1)a.push(n.get(h));
        return a;
    }
...
function Ut(g) {
    if (g instanceof OffscreenCanvas) return {
        width: g.width,
        height: g.height
    };
...
var z = class z2 {
    constructor(n){
        ...
        this._worker = z2._workerManager.getWorker(a), z2._workerManager.assignAnimationToWorker(this._id, a), z2._wasmUrl && this._sendMessage("setWasmUrl", {
            url: z2._wasmUrl
        }), this._create(n), this._worker.addEventListener("message", this._handleWorkerEvent.bind(this));
    }
    ...
    async _create(n) {
        ...
        let { instanceId: h } = await this._sendMessage("create", {
            instanceId: this._id,
            config: {
                ...n,
                canvas: a
    ...
    async setRenderConfig(n) {
        this._created && (await this._sendMessage("setRenderConfig", {
            instanceId: this._id,
            renderConfig: n
        }), await this._updateDotLottieInstanceState());
    }
    ...
    async loadTheme(n) {
        ...
        let a = this._sendMessage("loadTheme", {
            instanceId: this._id,
            themeId: n
        });
    ...
    async resize() {
        ...
        this._canvas.width = a, this._canvas.height = n, await this._sendMessage("resize", {
            height: n,
            instanceId: this._id,
            width: a
        }), await this._updateDotLottieInstanceState();
    ...
    async destroy() {
        this._created && (this._created = false, await this._sendMessage("destroy", {
            instanceId: this._id
        }), this._cleanupStateMachineListeners(), z2._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners());
    }
    async freeze() {
    ...
    async loadThemeData(n) {
        if (!this._created) return false;
        let a = await this._sendMessage("loadThemeData", {
            instanceId: this._id,
            themeData: n
        });
        return await this._updateDotLottieInstanceState(), a;
    ...
    async loadStateMachine(n) {
        if (!this._created) return false;
        let a = await this._sendMessage("loadStateMachine", {
            instanceId: this._id,
            stateMachineId: n
        });
        return await this._updateDotLottieInstanceState(), a;
...
function DotLottieComponent({ children, className = "", setCanvasRef, setContainerRef, style, ...rest }) {
    ...
    }, /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("canvas", {
        ref: setCanvasRef,
        style: {
            width: "100%",
            height: "100%"
...
var useDotLottie = (config)=>{
    ...
    const dotLottieRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const hoverHandler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((event)=>{
    ...
    const updateViewport = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
    ...
    const intersectionObserver = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
    ...
    const setCanvasRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((canvas)=>{
        canvasRef.current = canvas;
    }, []);
    const setContainerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((container)=>{
        containerRef.current = container;
    }, []);
    const Component = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((props)=>{
        return /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement(DotLottieComponent, {
            setContainerRef,
            setCanvasRef,
            ...props
        });
...
function useStableCallback(callback) {
    const callbackContainer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(callback);
    useIsomorphicLayoutEffect(()=>{
        callbackContainer.current = callback;
    });
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((...args)=>callbackContainer.current(...args), [
        callbackContainer
    ]);
}
// src/dotlottie.tsx
var DotLottieReact = ({ animationId, autoResizeCanvas = true, autoplay, backgroundColor, data, dotLottieRefCallback, loop, marker, mode, playOnHover, renderConfig, segment, speed, src, themeData, themeId, useFrameInterpolation, ...props })=>{
    ...
    return /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement(DotLottieComponent2, {
        ...props
    });
};
;
...
//# sourceMappingURL=node_modules_%40lottiefiles_dotlottie-react_dist_index_526db1db.js.map