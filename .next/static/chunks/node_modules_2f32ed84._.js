...
function DotLottieComponent({ children, className = "", setCanvasRef, setContainerRef, style, ...rest }) {
    ...
    }, /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement("canvas", {
        ref: setCanvasRef,
        style: {
            width: "100%",
            height: "100%"
...
var useDotLottie = (config)=>{
    ...
    const dotLottieRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const hoverHandler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDotLottie.useCallback[hoverHandler]": (event)=>{
    ...
    }["useDotLottie.useCallback[hoverHandler]"], []);
    const updateViewport = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDotLottie.useCallback[updateViewport]": ()=>{
    ...
    const intersectionObserver = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useDotLottie.useMemo[intersectionObserver]": ()=>{
            if (isServerSide()) return null;
            const observerCallback = {
                "useDotLottie.useMemo[intersectionObserver].observerCallback": (entries)=>{
                    entries.forEach({
                        "useDotLottie.useMemo[intersectionObserver].observerCallback": (entry)=>{
                    ...
                    }["useDotLottie.useMemo[intersectionObserver].observerCallback"]);
                }
            }["useDotLottie.useMemo[intersectionObserver].observerCallback"];
    ...
    const resizeObserver = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useDotLottie.useMemo[resizeObserver]": ()=>{
            if (isServerSide()) return null;
            const observerCallback = (0, import_debounce.default)({
                "useDotLottie.useMemo[resizeObserver].observerCallback": ()=>{
                    if (configRef.current?.autoResizeCanvas) {
                        dotLottieRef.current?.resize();
                    }
                }
            }["useDotLottie.useMemo[resizeObserver].observerCallback"], 150);
            return new ResizeObserver(observerCallback);
        }
    }["useDotLottie.useMemo[resizeObserver]"], []);
    const setCanvasRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDotLottie.useCallback[setCanvasRef]": (canvas)=>{
            canvasRef.current = canvas;
        }
    }["useDotLottie.useCallback[setCanvasRef]"], []);
    const setContainerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDotLottie.useCallback[setContainerRef]": (container)=>{
            containerRef.current = container;
        }
    }["useDotLottie.useCallback[setContainerRef]"], []);
    const Component = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDotLottie.useCallback[Component]": (props)=>{
            return /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement(DotLottieComponent, {
                setContainerRef,
                setCanvasRef,
                ...props
            });
        }
    }["useDotLottie.useCallback[Component]"], [
        setCanvasRef,
        setContainerRef
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useDotLottie.useEffect": ()=>{
            const canvas = canvasRef.current;
...
function useStableCallback(callback) {
    const callbackContainer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(callback);
    useIsomorphicLayoutEffect({
        "useStableCallback.useIsomorphicLayoutEffect": ()=>{
            callbackContainer.current = callback;
        }
    }["useStableCallback.useIsomorphicLayoutEffect"]);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useStableCallback.useCallback": (...args)=>callbackContainer.current(...args)
...
var DotLottieReact = ({ animationId, autoResizeCanvas = true, autoplay, backgroundColor, data, dotLottieRefCallback, loop, marker, mode, playOnHover, renderConfig, segment, speed, src, themeData, themeId, useFrameInterpolation, ...props })=>{
    ...
    return /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement(DotLottieComponent2, {
        ...props
    });
};
;
...
//# sourceMappingURL=node_modules_2f32ed84._.js.map