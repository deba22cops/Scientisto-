    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-3xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Preview examples of documents generated by Scientisto.
          </DialogDescription>
        </DialogHeader>
        <Tabs defaultValue="research" className="w-full">
          ...
          <ScrollArea className="h-96 mt-4 p-1">
            <TabsContent value="prd">
              <div className="prose prose-sm max-w-none text-foreground" dangerouslySetInnerHTML={{ __html: prdSample }} />
            </TabsContent>
            <TabsContent value="research">
              <div className="prose prose-sm max-w-none text-foreground" dangerouslySetInnerHTML={{ __html: researchPaperSample }} />
            </TabsContent>
          </ScrollArea>
        </Tabs>
      </DialogContent>
